/* src/config/cc-config.h.  Generated from cc-config.h.in by configure.  */
/* src/config/cc-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "http://bit.ccs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CC Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CC Core 4.0.0"
