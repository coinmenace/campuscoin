...
#define MASTERNODE_MIN_CONFIRMATIONS 5 // TODO CHANGE DEMO
...
#define TIERED_MASTERNODES_START_BLOCK 1
...
//
// The Masternode Class. For managing the process. It contains the input of the 10000 CC, signature to prove
