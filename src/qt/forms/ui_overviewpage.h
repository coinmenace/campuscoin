...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
        ...
        OverviewPage->resize(700, 510);
        OverviewPage->setMinimumSize(QSize(700, 510));
        ...
        label->setMinimumSize(QSize(300, 72));
        label->setMaximumSize(QSize(300, 72));
        label->setBaseSize(QSize(300, 72));
