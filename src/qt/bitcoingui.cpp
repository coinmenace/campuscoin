                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("CC-Coin") + " - ";
#ifdef ENABLE_WALLET
    ...
    progressBarLabel->setFixedWidth(157);
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a CC address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and cc: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About CC Core"), this);
    aboutAction->setStatusTip(tr("Show information about CC Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for CC"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your CC addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified CC addresses"));
    ...
    openAction->setStatusTip(tr("Open a CC: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the CC Core help message to get a list with possible CC command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("CC Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to CC network", "", count));
}
...
{
    QString strTitle = tr("CC Core"); // default title
